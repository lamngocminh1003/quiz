...
import { searchAllFilesByDate } from "../../services/fileService";
import DatePicker from "react-datepicker";
import "react-datepicker/dist/react-datepicker.css";
import moment from "moment";
const SearchAllFileByDate = (props) => {
  ...
  const handleSearch = async () => {
    if (!date) {
      ...
      try {
        let res = await searchAllFilesByDate(isoDate0Hour, sortOptions);
...
export default SearchAllFileByDate;
